...
const TransactionForm = ({ ref }: { ref: RefObject<HTMLDialogElement | null> }) => {
    ...
    return (
        <form onSubmit={handleSubmit} className=" my-3 p-3 bg-white">
            <p className="text-gray-600 "> * are mandatory</p>
            ...
            <label className="flex flex-col gap-2" htmlFor="amount"><span className="font-semibold">Description</span>
                <textarea value={transaction.description} placeholder="fruits and vegetables from instamart" className="border border-blue-500 rounded-sm placeholder:p-1 p-2 " rows={3} name="description" id="description" onChange={handleChange} />
            </label>
